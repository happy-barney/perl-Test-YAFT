...
Foundation functions are used to build higher level asserts, expectations, and/or tools.
...
These functions help you write your custom asserts, expectations, and/or tools.

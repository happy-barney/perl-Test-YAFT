...
Unlike L<expect_blessed_to|/expect_blessed_to>, this matches also inheritance.

	# Matches: bless {}, My::Class::
	# Also matches: bless {}, My::Class::Subclass::
	expect_instance_of (My::Class::)
...
Evaluates that C<$got> is either a blessed instance of the provided class,
or C<ref ($got)>> is the provided string (e.g., C<HASH>).

...
Unlike L<expect_obj_isa|/expect_obj_isa>, this checks for exact package blessing without
considering inheritance. The object must be blessed to the specified package name,
not a subclass.
